...
{
    // If already set, just return
    if(anIndex==_selIndex) return; int oldVal = _selIndex;
 ...
 */
FragView getSelView() { return _selIndex>=0 && _selIndex<getChildCount()? (FragView)getChild(_selIndex) : null; }
...
class FragView extends Label {
    ...
    {
        setText(aStr); setFont(LineView.this.getFont());

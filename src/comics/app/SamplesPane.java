...
protected View createUI()
{
    ...
    for(int i=0; i<SALL.length; i++) { String name = SALL[i];
        ...
        ColView ibox = new ColView(); ibox.setPrefSize(175,130); ibox.setAlign(Pos.TOP_CENTER);
    ...
    Label label = new Label("Select a script:"); label.setFont(Font.Arial16.getBold());
